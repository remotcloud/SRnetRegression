...
from .functions import _Function,_sympol_map,sigmoid
...
class _Program(object):
    ...
    def get_expression(self):
        ...
        for num in X_num:
            X_str = 'X%s'% num
            X = sympy.symbols(X_str)
            #symbol_set.append([X,num])
            symbol_set.append(X)
        return sympy.sympify(output,locals={'sigmoid_r': sigmoid}), symbol_set
