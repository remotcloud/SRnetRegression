...
class MinistData(object):
    def __init__(self):
        self.loadData("./data/mnist_all.mat")
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):  # 针对容器中的每一个批进行循环
            ...
            output,layer1 = net(data)  # 神经网络完成一次前馈的计算过程，得到预测输出output
    ...
    fname = 'ministCnn'
    torch.save(net.state_dict(), f"ModelSave/{fname}.pth")
